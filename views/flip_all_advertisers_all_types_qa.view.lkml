view: flip_all_advertisers_all_types_qa {
  sql_table_name: pocdb.flip_all_advertisers_all_types_qa ;;
  ...
  dimension: audio_apnx_date_time {
    type: number
    sql: ${TABLE}.audio_apnx_date_time ;;
  }
  ...
  dimension: display_apnx_date_time {
    type: number
    sql: ${TABLE}.display_apnx_date_time ;;
  }
  ...
  dimension: ott_apnx_date_time {
    type: number
    sql: ${TABLE}.ott_apnx_date_time ;;
  }
  ...
  dimension: performance_display {
    type: number
    sql: ${TABLE}.performance_display ;;
  }
  ...
  dimension: pixel_hour {
    type: number
    sql: ${TABLE}.pixel_hour ;;
  }
